<?php
// database/migrations/2024_01_01_000008_create_month_oep_table.php
...
return new class extends Migration
{
    ...
    {
        Schema::create('month_oep', function (Blueprint $table) {
            $table->id();
            $table->foreignId('month_id')->constrained('months')->cascadeOnDelete();
            $table->foreignId('expense_oep_id')->constrained('expenses_oep')->cascadeOnDelete();
